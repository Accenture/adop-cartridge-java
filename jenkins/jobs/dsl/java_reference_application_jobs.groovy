...
buildAppJob.with {
    ...
    scm scmProvider.get(projectScmNamespace, referenceAppgitRepo, "*/master", "pluggable-scm", null)
...
regressionTestJob.with {
    ...
    scm scmProvider.get(projectScmNamespace, regressionTestGitRepo, "*/master", "pluggable-scm", null)
    wrappers {
        preBuildCleanup()
        injectPasswords()
        maskPasswords()
